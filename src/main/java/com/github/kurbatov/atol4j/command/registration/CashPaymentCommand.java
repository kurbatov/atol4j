...
/**
 * Регестрирует выплату денежных средств.
 *
 * @author Олег Курбатов &lt;o.v.kurbatov@gmail.com&gt;
 */
public class CashPaymentCommand extends BasicCommand {

    private static final byte COMMAND = 0x4F;

    /**
     * Создаёт команду регистрации выплаты денежных средств.
     *
     * @param sum сумма в минимальных денежных единицах
     * @param test выполнить команду в тестовом режиме
     */
    public CashPaymentCommand(long sum, boolean test) {
        super(wrap(sum, test));
    }
