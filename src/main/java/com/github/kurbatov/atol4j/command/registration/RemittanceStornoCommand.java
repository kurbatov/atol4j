 ...
 */
public class RemittanceStornoCommand implements Command<RemittanceResult> {
    ...
    private static final byte COMMAND = (byte) 0x9B;
     ...
     */
    public RemittanceStornoCommand(long sum, byte paymentType, boolean test) {
