...
/**
 * Команда технологического обнуления ККТ.
 *
 * @author Олег Курбатов &lt;o.v.kurbatov@gmail.com&gt;
 */
public class ResetCommand extends BasicCommand {
    
    private static final byte COMMAND = 0x6B;
    
    /**
     * Экземпляр команды технического обнуления ККТ.
     */
    public static final ResetCommand INSTANCE = new ResetCommand();
    
    /**
     * Создаёт команду технологического обнуления ККТ.
     */
    public ResetCommand() {
        super(COMMAND);
    }
